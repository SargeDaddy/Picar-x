...
os.chdir(here)
sys.path.append('./ai_car')  # Change 'robot_hat' to 'ai_car'
from version import __version__

print("AI Car Python Library v%s" % __version__)  # Change name to AI Car
...
def install():
    ...
    # --- install ai_car package ---
    _if_build_isolation = ""
    if "--no-build-isolation" in options:
        _if_build_isolation = "--no-build-isolation"
    do(msg=f"install ai_car package {_if_build_isolation}",
